function [ P_out ] = robot_power_consumption( P_in,P_cap,P_regen,xPos,yPos,img )
% Computes the power consumption of the robot when it goes through shadows
% or ligth regions.

%   INPUTS:
%       P_left  = the power left in the robot at its current position
...
%       img     = the cost image matrix of the world
...
if(img(xPos,yPos) == 1)
    ...
    P_out = P_in + img(xPos,yPos)*P_regen;
    end
